...
ctr_image='ghcr.io/sando38/eturnal:edge'
restart_policy='unless-stopped'
## container specific variables
ctr_uid='9000'
app_data="$docker_dir/eturnal/appdata"
turn_relay_max_port='65535'
turn_relay_min_port='64000'
...
podman run -d --pod="$pod_name" \
    ...
    -v $app_data/etc/eturnal.yml:/etc/eturnal.yml \
    -e ETURNAL_RELAY_MAX_PORT="$turn_relay_max_port" \
    -e ETURNAL_RELAY_MIN_PORT="$turn_relay_min_port" \
  "$ctr_image"
